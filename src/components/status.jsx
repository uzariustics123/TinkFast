...
export const STATUS_OPTIONS = ['FairlySatisfactory', 'VerySatisfactory', 'Filled', 'DNME'];
...
const StyledChip = styled(Chip)(({ theme }) => ({
    ...
    '&.Satisfactory': {
        ...
        border: `1px solid ${colors.yellow.A100}`,
    },
    '&.DNME': {
...
const Status = React.memo((props) => {
    ...
    } else if (status === 'VerySatisfactory') {
        icon = <InfoIcon className="icon" />;
    } else if (status === 'FairlySatisfactory') {
    ...
    return (
        ...
        >
            {STATUS_OPTIONS.map((option) => {
                ...
                } else if (option === 'FairlySatisfactory') {
